          ...
          <div className="flex flex-col justify-start text-white">
            ...
            <div className="flex flex-col font-normal gap-3">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  className="bg-[#0A0F1D] appearance-none border-lg border border-white/10 rounded-lg py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:border-primary focus:border-2"
                  type="email"
              ...
              {/* Sign Up */}
              <button className="underline text-sm hover:text-primary delay-50">Not signed up yet?</button>
            </div>
          </div>
        </Modal>
